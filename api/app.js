...
//     const { description, name, recipeLink, stars, timeHours, timeMin, userId } = req.body;

//     // Validate input
//     if (!description || !name || !recipeLink || stars === undefined || timeHours === undefined || timeMin === undefined) {
//       return res.status(400).json({ error: 'All fields are required.' });
//     }
...
//     // Reference to the user's document and the 'posts' sub-collection
//     const userDocRef = db.collection('users').doc(userId);  
//     const postCollection = userDocRef.collection('posts');

//     // Auto-generate ID for the new post
//     const newPostRef = postCollection.doc();

//     // Create new post document with the provided data
//     const newPost = { ...req.body, postId: newPostRef.id };

//     // Set the new post in Firestore
//     await newPostRef.set(newPost);
...
// //   try {
// //         console.log('Received request body:', req.body);
// //         const { description, name, recipeLink, stars, timeHours, timeMin } = req.body;
